        ...
        <div class="row">
            <div class="col-md-6">
                <div class="card card-primary">
                    ...
                    <div class="card-body">
                    <form action="../../model/dao/servico/update.php" method="POST" id="quickForm">
                        <input type="hidden" name="idusuario" value="<?php echo $idusuario; ?>">
                        <input type="hidden" name="id" value="<?php echo $dados['IDSERVICO']; ?>">
                            ...
                            <div class="row">
                                <div class="col-12">
                                    ...
                                    <input type="submit" value="Salvar" class="btn btn-success float-right" name="btn-editar-servico">
                                </div>
                            </div>
                        </form>
                    </div>
