        ...
        <div class="row">
            <div class="col-md-6">
                <div class="card card-primary">
                    ...
                    <div class="card-body">
                        <form action="../../model/dao/servidor/create.php" method="POST" id="quickForm">
                        <input type="hidden" name="idusuario" value="<?php echo $idusuario; ?>">
                        <input type="hidden" name="id" value="<?php echo $id; ?>">
                        <input type="hidden" name="idcliente" value="<?php echo $dados['IDCLIENTE']; ?>">
                        <input type="hidden" name="idservico" value="<?php echo $dados['IDSERVICO']; ?>">
                            ...
                            <div class="row">
                                <div class="col-12">
                                    <a href="../servicoclienteview/view.php?user=<?php echo $idusuario; ?>&id=<?php echo $id; ?>" class="btn btn-secondary">Voltar</a>
                                    <input type="submit" value="Cadastrar" class="btn btn-success float-right" name="btn-cadastrar-servidor">
                                </div>
                            </div>
                        </form>
                    </div>
