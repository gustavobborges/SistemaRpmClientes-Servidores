...
<head>
    ...
    <script type="text/javascript" rel="stylesheet" src="../../../js/bootstrap.js">
    </script>
    ...
    <aside class="main-sidebar sidebar-dark-primary elevation-4">
        <!-- Brand Logo -->
            <a href="../home/home.php?user=<?php echo $dados['IDUSUARIO']; ?>" class="brand-link logo-switch logoa">
                <img class="logo" src="../../../img/dash2" alt="logo_ibridge">
            </a>
        ...
        <div class="sidebar">
            ...
            <div class="user-panel mt-3 pb-3 mb-3 d-flex">
                <div class="info">
                    <a href="../home/home.php?user=<?php echo $dados['IDUSUARIO']; ?>" class="d-block">Bem Vindo(a), &nbsp <?php echo $dados['NOME'] ?>!</a>
                </div>
            </div>
